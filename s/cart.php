...
if(isset($_POST["add_to_cart"]))
{
	if(isset($_SESSION["shopping_cart"]))
	{
		...
		if(!in_array($_GET["id"], $item_array_id))
		{
            ...
            echo '<script>alert("You are Adding more items than existing stock. We only have '.$_POST["hidden_quantity"].' in stock")</script>';
        }
		}
		else
		{
	...
	<body>
		...
		<div class="container">
			<?php
				...
				?>
			<div class="col-md-4">
				<form method="post" action="cart.php?action=add&id=<?php echo $row["StockID"]; ?>">
